...
# معرف الحساب لاستقبال الشكاوى والاقتراحات مباشرة
...
SUBJECTS_DATA = {
    "علمي": {
        ...
        "arabic": ["نحو", "صرف", "بلاغة", "أدب ونصوص"],
        "science": ["كيمياء", "فيزياء", "تاريخ", "رياضيات", "إنجليزي"]
    },
    "أدبي": {
        "sharia": ["فقه", "توحيد", "حديث", "تفسير", "منطق"],
        "arabic": ["نحو", "صرف", "بلاغة", "أدب ونصوص", "مطالعة", "عروض وقافية"],
        "science": ["تاريخ", "جغرافيا", "فلسفة", "إنجليزي", "فرنساوي"]
    }
}
